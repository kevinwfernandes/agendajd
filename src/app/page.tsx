    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 py-8">
        <div className="text-center my-12">
          <h1 className="h1 mb-4">Bem-vindo ao AgendaJD</h1>
          ...
          <div className="flex justify-center space-x-4">
            <button className="btn-primary px-6 py-3">Ver Eventos</button>
            <button className="btn-secondary px-6 py-3">Acessar Mural</button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 my-12">
          <div className="card">
            ...
            <h2 className="h2 text-center mb-2">Eventos e Agenda</h2>
          ...
          <div className="card">
            ...
            <h2 className="h2 text-center mb-2">Recados no Mural</h2>
            <p className="text-center">
          ...
          <div className="card">
            ...
            <h2 className="h2 text-center mb-2">Notificações</h2>
            <p className="text-center">
